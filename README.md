...
Helps to pass props down and the component tree

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

Actions send data to the store, reducers take a previous state an action and returns the next state, 
Store is saves the whole state of app in immutable object tree.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

components dont have the whole application state, sub components are food for smaller tasks, while application state is good for overall functionality

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

redux thunk allows us to execute async code, it uses dispatch methods in actioin-creators.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
Redux, I think its great to use in more components.
